...
import com.example.totallearn.mvp_set.mvpwangyi_2.base.BasePresenter;
import com.example.totallearn.mvp_set.mvpwangyi_2.bean.UserInfo;


public class LoginPresenter extends BasePresenter<MvpLoginActivity, LoginMode, LoginContract.Presenter> {
