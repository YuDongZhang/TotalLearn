...
public class ViewPagerHelper implements ViewPager.OnPageChangeListener {
    ...
    public static final String TAG = ViewPagerHelper.class.getSimpleName();
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        MyLogUtil.d(TAG, "enterPosition=" + enterPosition + "   leavePosition=" + leavePosition + "      percent=" + percent);
