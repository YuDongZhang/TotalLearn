...
public class UserManager4 {
    ...
    UserStroe4 mUserStroe4;
    ApiService4 mApiService4;

    @Inject
    public UserManager4(UserStroe4 mUserStroe4, ApiService4 mApiService4) {
        this.mUserStroe4 = mUserStroe4;
        this.mApiService4 = mApiService4;
    }

    public void register4() {
        mApiService4.register4();
        mUserStroe4.login4();
    }
...
Dagger4该如何解决。这里我把需求再复杂话一些。首先我们还是先从module来看：
