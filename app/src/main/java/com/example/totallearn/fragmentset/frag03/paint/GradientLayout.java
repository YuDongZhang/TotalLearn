...
//        mPaint.setStrokeCap(Paint.Cap.ROUND); //圆角效果 //三种不同的
//        mPaint.setStrokeJoin(Paint.Join.MITER);//拐角风格 //三种不同的
...
////        canvas.drawCircle(250, 250, 250, mPaint); //圆心,半径
...
//        canvas.drawCircle(250, 250, 250, mPaint);
        ...
        mShader = new ComposeShader(bitmapShader, linearGradient, PorterDuff.Mode.MULTIPLY);//混合的规则
        mPaint.setShader(mShader);
        canvas.drawCircle(250, 250, 250, mPaint);
