...
public class ItemProgress extends View {
    ...
    private int innerStrokeBackgroundColor;
    ...
    private final int default_inner_Stroke_background_color = Color.WHITE;
    ...
    public ItemProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.DonutProgress,
                defStyleAttr, 0);
    ...
    protected void initPainters() {
        ...
        finishedPaint.setColor(Color.parseColor("#3596ce"));
        ...
        innerCircleStrokePaint = new Paint();
        innerCircleStrokePaint.setColor(default_inner_Stroke_background_color);
        innerCircleStrokePaint.setStyle(Paint.Style.STROKE);
        innerCircleStrokePaint.setAntiAlias(true);
        innerCircleStrokePaint.setStrokeWidth(1);
    }
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        //innerStrokeWidth = attributes.getDimension(R.styleable.DonutProgress_donut_inner_stroke_width, default_stroke_width);
        ...
        //innerStrokeBackgroundColor = attributes.getColor(R.styleable.DonutProgress_donut_background_Stroke_color, default_inner_Stroke_background_color);
    }
...
//        }
    ...
    public int getInnerStrokeBackgroundColor() {
        return innerStrokeBackgroundColor;
    }

    public void setInnerStrokeBackgroundColor(int innerStrokeBackgroundColor) {
        this.innerStrokeBackgroundColor = innerStrokeBackgroundColor;
        this.invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(unfinishedOuterRect, getProgressAngle() - 90 , 480 - getProgressAngle(),
                false, unfinishedPaint);

        canvas.drawArc(finishedOuterRect, -120, getProgressAngle(), false, finishedPaint);

        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, innerCircleRadius - Math.min(finishedStrokeWidth, unfinishedStrokeWidth) / 2, innerCircleStrokePaint);



        String text = days + suffixText;
        // 将坐标原点移到控件中心
